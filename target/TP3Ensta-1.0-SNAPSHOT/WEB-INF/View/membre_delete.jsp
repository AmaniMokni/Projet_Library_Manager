...
<body>
  ...
  <main>
    <section class="content">
      ...
      <div class="row">
      <div class="container">
      <h5>Suppression du membre n <c:out value="${membre.id}" /></h5> <!-- TODO : remplacer 312 par l'id du membre -->
        <div class="row">
          <p>etes-vous sur de vouloir supprimer la fiche de <c:out value="${membre.prenom}" /> <c:out value="${membre.nom}" /> ?</p> <!-- TODO : remplacer prenomDuMembre et nomDuMembre par les valeurs correspondantes -->
